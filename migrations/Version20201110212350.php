 ...
 */
final class Version20201110212350 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE date_added date_added DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE date_added date_added DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    }
}
